...
The transcript is copied to the clipboard and pasted into the app that was active when recording started.
...
Supported hotkey aliases currently include `cmd`, `command`, `option`, and `alt`. Modifier-only hotkeys need Accessibility/Input Monitoring permissions.
